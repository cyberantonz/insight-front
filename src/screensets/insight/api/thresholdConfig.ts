...
export const BULLET_DEFS: BulletThresholdDef[] = [
  ...
  // Backend ships estimation_accuracy inside task_delivery_bullet_rows; duplicate the def here so the label matches.
  // Backend computes a centered score (100 - |100 - ratio|), i.e. 100 = estimate matched actuals, 50 = off by 2×,
  // so the natural range is 0..100 and higher is better.
  { metric_key: 'estimation_accuracy', section: 'task_delivery', label: 'Estimation Accuracy',               sublabel: 'Jira \u00b7 how close estimate matches actual time',                     unit: '%',     drill_id: '',               higher_is_better: true,  range_min: 0,  range_max: 100, median: 58,  good_threshold: 80,  warn_threshold: 50  },
  ...
  { metric_key: 'cc_tool_accept',     section: 'ai_adoption',   label: 'Claude Code Tool Acceptance',        sublabel: 'Anthropic Enterprise API \u00b7 accepted \u00f7 offered \u00b7 team median', unit: '%', drill_id: '',               higher_is_better: true,  range_min: 0,  range_max: 100, median: 64,  good_threshold: 60,  warn_threshold: 40  },
  // Cursor detail metrics (backend returns these separately from the headline *_active counts).
  { metric_key: 'cursor_lines',       section: 'ai_adoption',   label: 'Cursor Accepted Lines',              sublabel: 'Cursor \u00b7 lines accepted from AI suggestions \u00b7 team total',   unit: 'lines', drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 1000, median: 200, good_threshold: 100, warn_threshold: 30  },
  { metric_key: 'cursor_agents',      section: 'ai_adoption',   label: 'Cursor Agent Interactions',          sublabel: 'Cursor \u00b7 agent-mode actions \u00b7 team avg',                     unit: '/mo',   drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 100,  median: 10,  good_threshold: 10,  warn_threshold: 3   },
  { metric_key: 'cursor_completions', section: 'ai_adoption',   label: 'Cursor Completions',                 sublabel: 'Cursor \u00b7 inline completions offered \u00b7 team avg',             unit: '/mo',   drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 200,  median: 40,  good_threshold: 30,  warn_threshold: 10  },
  // Claude Code detail metrics.
  { metric_key: 'cc_lines',           section: 'ai_adoption',   label: 'Claude Code Accepted Lines',         sublabel: 'Anthropic Enterprise API \u00b7 lines accepted from tool calls',       unit: 'lines', drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 500,  median: 80,  good_threshold: 50,  warn_threshold: 10  },
  { metric_key: 'cc_sessions',        section: 'ai_adoption',   label: 'Claude Code Sessions',               sublabel: 'Anthropic Enterprise API \u00b7 sessions per member \u00b7 team avg',  unit: '/mo',   drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 40,   median: 6,   good_threshold: 4,   warn_threshold: 1   },
  // Other AI surfaces.
  { metric_key: 'chatgpt',            section: 'ai_adoption',   label: 'ChatGPT Activity',                   sublabel: 'ChatGPT Team \u00b7 active members (placeholder)',                     unit: '/ 12',  drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 12,   median: 0,   good_threshold: 2,   warn_threshold: 0   },
  { metric_key: 'claude_web',         section: 'ai_adoption',   label: 'Claude.ai Activity',                 sublabel: 'Claude.ai web \u00b7 active members (placeholder)',                    unit: '/ 12',  drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 12,   median: 0,   good_threshold: 2,   warn_threshold: 0   },
  // Secondary AI LOC share (backend ships alongside team_ai_loc).
  { metric_key: 'ai_loc_share2',      section: 'ai_adoption',   label: 'AI LOC Share (v2)',                  sublabel: 'Alternate AI-accepted \u00f7 total lines calc',                         unit: '%',     drill_id: '',             higher_is_better: true,  range_min: 0,  range_max: 50,   median: 14,  good_threshold: 14,  warn_threshold: 8   },
